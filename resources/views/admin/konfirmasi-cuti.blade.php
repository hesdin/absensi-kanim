      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between">
          <div class="header-title">
            <h5 class="card-title">Konfirmasi Cuti</h5>
          </div>
        </div>
              ...
              <tbody>
                ...
                @forelse ($cutis as $cuti )
                  <tr>
                    ...
                    <td>{{ $cuti->jc }}</td>
                    <td>{{ Carbon\Carbon::parse($cuti->date)->format('Y/m/d') }}</td>
                    <td>
                      <a target="_blank" class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip" title="" href="{{ route('admin.foto.cuti', $cuti->id) }}" data-bs-original-title="Lihat Foto">
                    ...
                    <td>
                      ...
                      <a class="btn btn-sm btn-icon text-success flex-end" data-bs-toggle="tooltip" title="" href="{{ route('admin.terima.cuti', $cuti->id) }}" data-bs-original-title="Terima">
                        <span class="btn-inner">
                      ...
                      {{-- <a class="btn btn-sm btn-icon text-danger " data-bs-toggle="tooltip" title="" href="{{ route('admin.tolak.cuti', $cuti->id) }}" onclick="event.preventDefault();document.getElementById('tolak-cuti').submit();" data-bs-original-title="Tolak">

                        <form action="{{ route('admin.tolak.cuti', $cuti->id) }}" method="POST" class="d-none" id="tolak-cuti">@csrf @method('DELETE')
                        </form>
                      ...
                      <a class="btn btn-sm btn-icon text-danger " data-bs-toggle="tooltip" title="" href="{{ route('admin.tolak.cuti', $cuti->id) }}" data-bs-original-title="Tolak">
